...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#382bf7e8#;
   ...
   u00133 : constant Version_32 := 16#8f461df5#;
   pragma Export (C, u00133, "text_ioS");
   u00134 : constant Version_32 := 16#200d9fa4#;
   pragma Export (C, u00134, "vectorsB");
   u00135 : constant Version_32 := 16#54f5d6ae#;
   pragma Export (C, u00135, "vectorsS");
